      ...
      >
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">Begin met het bouwen van je website</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <Link href="/auth/inloggen" className="text-modual-purple font-semibold hover:underline">
              Log hier in
            </Link>
          </p>
        </div>
